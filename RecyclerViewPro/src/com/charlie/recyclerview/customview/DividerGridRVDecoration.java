...
/**
 * 参考：MDGridRvDividerDecoration.java
 * http://www.jianshu.com/p/7c3c549a0ec4
 * @author Charlie
 *
 */
public class DividerGridRVDecoration extends RecyclerView.ItemDecoration {

    private static final int[] ATTRS = new int[]{
            android.R.attr.listDivider
    };
    private static DividerGridRVDecoration decoration;
    public static   DividerGridRVDecoration getInstance(Context context) {
    	if(decoration==null){
    		decoration=new DividerGridRVDecoration(context);
    	}
    	return decoration;
    }
    public static   DividerGridRVDecoration getInstance(Context context,RecyclerView rv) {
    	if(decoration==null){
    		decoration=new DividerGridRVDecoration(context);
    	}
    ...
    public DividerGridRVDecoration(Context context) {
        // 获取默认主题的属性
        final TypedArray a = context.obtainStyledAttributes(ATTRS);
        mDivider = a.getDrawable(0);
        a.recycle();
    }
	private int getOrien(RecyclerView parent){
		int orientation = 0;
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        int orientation =getOrien(parent);
