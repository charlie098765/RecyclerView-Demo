...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static   DividerItemDecoration getInstance(Context context, int orientation) {
    	if(decoration==null){
    		decoration=new DividerItemDecoration(context, orientation);
    	}
    	//must delete before use
    	return decoration;
    }
    public static   DividerItemDecoration getInstance(Context context,RecyclerView rv, int orientation) {
    	if(decoration==null){
    		decoration=new DividerItemDecoration(context, orientation);
    	}
    	//must delete before use
