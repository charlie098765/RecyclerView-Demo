...
public class CustomRecyclerViewMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_recyclerview_main);
        initList();
        iv_show_detail= (ImageView) findViewById(R.id.iv_show_detail);
        rv= (CustomRecyclerView) findViewById(R.id.rv_test);
        
        adapter=new  DataAdapter(CustomRecyclerViewMainActivity.this,list);
       StaggeredAdapter=new StaggeredDataAdapter(CustomRecyclerViewMainActivity.this,list);
       
    // 设置item动画
       rv.setItemAnimator(new DefaultItemAnimator());
       rv.setOnItemScrollListener(new OnItemScrollListener() {
		
		@Override
		public void onItemScrollChanged(View view, int position) {
...
//       rv.setLayoutManager(new StaggeredGridLayoutManager(5,StaggeredGridLayoutManager.HORIZONTAL));
       ...
       rv.setAdapter(adapter);
		   rv.addItemDecoration(DividerGridItemDecoration.getInstance(this,rv));
...
//		rv.addItemDecoration(DividerGridRVDecoration.getInstance(CustomRecyclerViewMainActivity.this,rv));
...
//		rv.addItemDecoration(DividerGridRVDecoration.getInstance(this, rv));
		initEvent(adapter);
    ...
    private void initEvent(Adapter mAdapter)
    {
    	OnItemClickLitener litener = new OnItemClickLitener() {
    		...
    		{
    			Toast.makeText(CustomRecyclerViewMainActivity.this, position + " click",
    		...
    		{
    			Toast.makeText(CustomRecyclerViewMainActivity.this, position + " long click",
    					Toast.LENGTH_SHORT).show();
    			iv_show_detail.setImageResource(C.ICONS[position]);
    		}
    	};
